...
# Copyright 2024 (c) Vladislav Punko <iam.vlad.punko@gmail.com>
...
# Step -- 1.
git clone --depth=1 --branch=master -- https://github.com/vladpunko/gitmirror.git "${workdir}" > /dev/null 2>&1 || {
